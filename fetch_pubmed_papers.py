#!/usr/bin/env python3
"""
Script to fetch papers from PubMed search for "Azacytidine cmml"
...
class PubMedFetcher:
    def __init__(self):
        ...
        self.email = "research@example.com"  # Replace with actual email if needed
...
def main():
    ...
    # Search for "Azacytidine cmml" papers
    query = "Azacytidine cmml"
    print(f"Searching PubMed for: {query}")
    
    pmids = fetcher.search_pubmed(query, max_results=50)  # Limit to 50 for testing
    ...
    # Organize papers by drug (all will be azacitidine for this search)
    organized_data = {
        'azacitidine': []
    }
    ...
    for paper in papers:
        ...
        organized_data['azacitidine'].append(paper_data)
    
    # Save the fetched data
    output_file = 'pubmed_azacitidine_cmml.json'
